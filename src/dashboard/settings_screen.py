...
SWC_DISPLAY_NAMES = {
    "SWC_VOLUP": "VOL+", "SWC_VOLDN": "VOL-", "SWC_UP": "UP", "SWC_DOWN": "DOWN",
    "SWC_MUTE": "MUTE", "SWC_MODE": "MODE", "SWC_NEXT": "NEXT", "SWC_PREV": "PREV",
    "SWC_PICKUP": "PICKUP", "SWC_HANGUP": "HANGUP", "SWC_VOICE": "VOICE", "SWC_SRC": "SRC",
}
...
class SettingsScreen:
    ...
    def draw(self, surface: pygame.Surface, theme: ThemeBase,
        ...
        if self.page == PAGE_GENERAL:
            title_text = t("settings_title", lang)
        else:
            title_text = t("swc_title", lang)
        ...
        if self.page == PAGE_GENERAL:
            help_text = t("settings_nav", lang)
        else:
            help_text = t("swc_nav", lang)
