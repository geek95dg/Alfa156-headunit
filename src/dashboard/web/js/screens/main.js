                ...
                <div class="grid grid-cols-12 gap-4 w-full max-w-5xl px-6 h-full py-4">
                    ...
                    <div class="col-span-3 burl-texture rounded-xl border border-zinc-800 p-4 flex flex-col justify-between overflow-hidden">
                        <div class="flex items-center gap-2 text-zinc-500">
                            ...
                            <span class="text-[10px] font-bold uppercase tracking-wider">Engine Temp</span>
                        </div>
                        <div class="relative py-4 flex flex-col items-center">
                            ...
                            <span class="text-[10px] text-zinc-500 mt-2 font-bold">${temp > 95 ? 'HOT' : 'OPTIMAL'}</span>
                        </div>
                    </div>
                    <!-- Notifications -->
                    <div class="col-span-6 bg-zinc-950 rounded-xl border border-zinc-800 p-6 flex flex-col gap-4 relative overflow-hidden">
                        ...
                        <div class="flex items-center justify-between border-b border-zinc-900 pb-2">
                            <h2 class="text-xs font-black uppercase tracking-[0.2em] text-zinc-400">System Notifications</h2>
                    ...
                    <div class="col-span-3 burl-texture rounded-xl border border-zinc-800 p-4 flex flex-col justify-between overflow-hidden">
                        <div class="flex items-center gap-2 text-zinc-500">
                            ...
                            <span class="text-[10px] font-bold uppercase tracking-wider">Fuel Level</span>
                        </div>
                        <div class="flex flex-col gap-1 py-4">
                            ...
                            <p class="text-[10px] text-zinc-500 mt-1 font-bold">EST. RANGE: <span id="range-val">${range} KM</span></p>
                        </div>
                    </div>
                    <!-- Bottom Row -->
                    ...
                    <div class="col-span-8 bg-zinc-900/30 rounded-xl border border-zinc-800 p-4 flex items-center justify-between px-8">
                        <div class="flex flex-col items-center">
                            <span class="text-[10px] text-zinc-500 font-bold uppercase">Avg Speed</span>
                        ...
                        <div class="flex flex-col items-center">
                            <span class="text-[10px] text-zinc-500 font-bold uppercase">Drive Time</span>
                            <span id="drive-time-val" class="text-xl font-black text-zinc-200">${data.trip_time || "0h 0m"}</span>
                        </div>
                        <div class="w-px h-8 bg-zinc-800"></div>
                        <div class="flex flex-col items-center">
                            <span class="text-[10px] text-zinc-500 font-bold uppercase">Voltage</span>
                ...
                <div class="col-span-3 flex flex-col gap-4">
                    <div class="bg-white p-4 rounded-xl shadow-sm border border-slate-100">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Engine Temp</span>
                    ...
                    <div class="bg-white p-4 rounded-xl shadow-sm border border-slate-100">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Fuel Level</span>
                        ...
                        <div class="mt-1 text-[10px] text-slate-400 font-medium">EST. RANGE: <span id="range-val">${range} KM</span></div>
                    </div>
                </div>
            ...
            <main class="content-area flex flex-row overflow-hidden relative">
                ...
                <div class="w-1/3 flex flex-col p-6 gap-6 justify-center border-r border-[#222222] bg-gradient-to-r from-[#0a0a0a] to-transparent z-10">
                    <div class="flex flex-col gap-2">
                        <div class="flex justify-between items-end mb-1">
                            <span class="text-sm font-medium text-gray-400 uppercase tracking-widest">Coolant</span>
                    ...
                    <div class="flex flex-col gap-2 mt-4">
                        <div class="flex justify-between items-end mb-1">
                            <span class="text-sm font-medium text-gray-400 uppercase tracking-widest">Fuel</span>
                    ...
                    <div class="flex flex-col gap-2 mt-4">
                        <div class="flex justify-between items-end mb-1">
                            <span class="text-sm font-medium text-gray-400 uppercase tracking-widest">Oil Press</span>
                ...
                <div class="flex-1 flex flex-col p-6 relative">
                    ...
                    <div class="flex-1 flex flex-col relative z-10">
                        <h3 class="text-sm font-bold text-[#FF5F00] uppercase tracking-widest mb-4">Current Status</h3>
                        ${notifHtml}
                        <div class="mt-auto">
