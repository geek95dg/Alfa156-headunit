            ...
            <main class="content-area flex overflow-hidden">
                ...
                <div class="w-[340px] relative shrink-0 flex items-center justify-center p-4">
                    <div class="w-full h-full rounded-xl bg-zinc-900/40 border border-zinc-800 relative overflow-hidden flex items-center justify-center">
                        ...
                        <div class="absolute bottom-2 left-3 right-3 flex justify-between items-end">
                            <div>
                                <p class="text-[9px] text-zinc-600 uppercase tracking-wider">Vehicle</p>
                                <p class="text-xs font-bold text-amber-500">Giulia GTA 1965</p>
                            </div>
                            <span class="text-[9px] text-zinc-600">Next svc: <span class="text-amber-500 font-bold">${serviceKm}</span> km</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex-1 flex flex-col p-4 gap-2">
                    <div class="flex items-center justify-between mb-1">
                        <h2 class="text-lg font-bold text-amber-500 amber-glow">System Status</h2>
                        <span class="text-[9px] font-bold px-2 py-0.5 bg-green-900/40 text-green-400 rounded">ALL OK</span>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-2 flex-1">
                        <div class="bg-zinc-900/60 border border-zinc-800 rounded-lg p-2 flex items-center gap-2">
                            ...
                            <div class="flex-1">
                                <p class="text-[8px] text-zinc-500 uppercase">Engine</p>
                        ...
                        <div class="bg-zinc-900/60 border border-zinc-800 rounded-lg p-2 flex items-center gap-2">
                            ...
                            <div class="flex-1">
                                <p class="text-[8px] text-zinc-500 uppercase">Oil Life</p>
                        ...
                        <div class="bg-zinc-900/60 border border-zinc-800 rounded-lg p-2 flex items-center gap-2">
                            ...
                            <div class="flex-1">
                                <p class="text-[8px] text-zinc-500 uppercase">Battery</p>
                        ...
                        <div class="bg-zinc-900/60 border border-zinc-800 rounded-lg p-2 flex items-center gap-2">
                            ...
                            <div class="flex-1">
                                <p class="text-[8px] text-zinc-500 uppercase">TPMS</p>
                                <p class="text-sm font-bold text-zinc-200">${tpms[0].toFixed(1)}/${tpms[1].toFixed(1)}</p>
                            </div>
                            <span class="text-[9px] font-bold ${tpms.some(p => p > 0 && p < 2.0) ? 'text-amber-400' : 'text-green-400'}">${tpms.some(p => p > 0 && p < 2.0) ? 'LOW' : 'OK'}</span>
                        </div>
                    </div>
                    <!-- TPMS detail row -->
    ...
    function _renderModern(data) {
        ...
        return `<div class="screen-container" style="background:#f8fafc;color:#0f172a;">
            ...
            <main class="content-area flex overflow-hidden" style="background:#fff;">
                ...
                <div class="w-[320px] relative shrink-0 p-4 flex items-center justify-center">
                    <div class="w-full h-full rounded-xl bg-slate-50 border border-slate-200 relative overflow-hidden flex items-center justify-center shadow-sm">
                        ...
                        <div class="absolute bottom-2 left-3 right-3 flex justify-between items-end">
                            ...
                            <span class="text-[9px] text-slate-400">Svc: <span class="font-bold text-[#005596]">${serviceKm}</span> km</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex-1 flex flex-col p-4 gap-2">
                    <div class="flex items-center justify-between mb-1">
                        <h2 class="text-lg font-extrabold text-slate-900 tracking-tighter">A4 SERVICE</h2>
                        <span class="text-[9px] font-bold text-emerald-600 bg-emerald-100 px-2 py-0.5 rounded">OPTIMAL</span>
                    </div>
                    <!-- Compact engine + oil row -->
                    <div class="flex gap-2">
                        <div class="flex-1 bg-slate-50 border border-slate-200 p-2 rounded-lg">
                            <div class="flex justify-between items-center mb-1">
                                <span class="text-[8px] font-bold text-slate-400 uppercase">Engine</span>
                        ...
                        <div class="w-[80px] bg-slate-900 p-2 rounded-lg text-white flex flex-col items-center justify-center shrink-0">
                            <span class="text-[8px] text-slate-400 uppercase">Oil</span>
                            <span id="svc-oil" class="text-xl font-extrabold">${oilPct}%</span>
                        </div>
                        <div class="flex-1 bg-slate-50 border border-slate-200 p-2 rounded-lg">
                            <div class="flex justify-between items-center mb-1">
                                <span class="text-[8px] font-bold text-slate-400 uppercase">Battery</span>
        ...
        return `<div class="screen-container bg-black text-white">
            ...
            <main class="content-area flex overflow-hidden">
                ...
                <div class="w-[260px] border-r border-[#ec5b13]/30 flex flex-col p-3 gap-2 shrink-0">
                    <h2 class="text-[#ec5b13] font-bold text-lg uppercase tracking-wider mb-1">Diagnostics</h2>
                    ${_autoDiagCard("Engine", `${temp}°C`, "device_thermostat")}
                    ${_autoDiagCard("Oil Press", `${oil} PSI`, "oil_barrel")}
                    ${_autoDiagCard("Battery", `${batteryV}V`, "battery_charging_full")}
                    ${_autoDiagCard("TPMS", `${tpms[0].toFixed(1)} BAR`, "tire_repair")}
                    <div class="mt-auto text-[9px] text-zinc-600">Next service: <span class="text-[#ec5b13] font-bold">${serviceKm}</span> km</div>
                </div>
